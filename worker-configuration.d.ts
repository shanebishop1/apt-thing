/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.example` (hash: f4119721c21a2597169e2e19b26f1a4e)
...
interface __BaseEnv_Env {
	...
	DAILY_SOURCE_AGENT_LOOP_WORKFLOW: Workflow<Parameters<import("./src/worker").DailySourceAgentLoopWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DAILY_LOOP_ENABLED" | "APP_ENV" | "NEXTJS_ENV" | "GEMINI_API_KEY" | "REALTYAPI_KEY" | "STADIA_MAPS_API_KEY">> {}
}
